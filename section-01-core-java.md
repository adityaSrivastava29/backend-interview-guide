...
13. _Your application has a 10-second startup time. How do you reduce it?_
...
14. _Your application has a ClassNotFoundException in production after deployment. What do you check?_
...
10. _Your application throws `OutOfMemoryError: Java heap space` in production. Walk me through diagnosing this._
...
11. _Your microservice has 99th percentile latency of 3 seconds. GC logs show 2-second pauses. What do you do?_
